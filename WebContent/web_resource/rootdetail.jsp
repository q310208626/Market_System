...
<body>
	<div id="content">
		...
		<div id="content_main">
			<div id="catagory_div">
				<ul>
					<li><a href="getUserDetailAction" target="manager_ifr">修改个人信息</a></li>
					<li><a href="getUserPwdAction" target="manager_ifr">修改密码</a></li>
					<li><a href="getUserPwdAction" target="manager_ifr">订单管理</a></li>
					<li><a href="toFlowerManagerAction" >商品管理</a></li>
				</ul>
			</div>
			<div id="content_show">
				<iframe id="ifr" name="manager_ifr" src="getUserDetailAction"></iframe>
			</div>
		</div>
